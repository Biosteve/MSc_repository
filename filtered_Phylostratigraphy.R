...
# Sapiens_set2 <- Sapiens_set %>% inner_join(filtered_Average_0, by = "Gene")
# Sapiens_set2 <- Sapiens_set2[, -c(10:19)]
# colnames(Sapiens_set2)[colnames(Sapiens_set2) == "filtered_Average"] <- "filtered_Average_0"
# 
# Sapiens_set3 <- Sapiens_set2 %>% inner_join(filtered_Average_1, by = "Gene")
# Sapiens_set3 <- Sapiens_set3[, -c(11:20)]
# colnames(Sapiens_set3)[colnames(Sapiens_set3) == "filtered_Average"] <- "filtered_Average_1"
# 
# Sapiens_set4 <- Sapiens_set3 %>% inner_join(filtered_Average_7, by = "Gene")
# Sapiens_set4 <- Sapiens_set4[, -c(12:21)]
# colnames(Sapiens_set4)[colnames(Sapiens_set4) == "filtered_Average"] <- "filtered_Average_7"
# 
# Sapiens_set4 <- na.omit(Sapiens_set4) #removes rows with NaNs
# 
# graphing_SS4_0<- ggplot(Sapiens_set4, aes(x=Gene, y=filtered_Average_0, color=Gene)) + scale_y_continuous(limits = c(0,6)) + geom_boxplot(alpha=1) + labs(title="Testing") + labs(x= "Gene", y="Mean Distance from Center") + theme(axis.line.x = element_line(linewidth = 0.5, colour = "black"), legend.position="bottom", legend.direction="horizontal", legend.title = element_blank(), plot.title = element_text(family = "Calibri"), text = element_text(family = "Calibri"))
# graphing_SS4_1<- ggplot(Sapiens_set4, aes(x=Gene, y=filtered_Average_1, color=Gene)) + scale_y_continuous(limits = c(0,6)) + geom_boxplot(alpha=1) + labs(title="Testing") + labs(x= "Gene", y="Mean Distance from Center") + theme(axis.line.x = element_line(linewidth = 0.5, colour = "black"), legend.position="bottom", legend.direction="horizontal", legend.title = element_blank(), plot.title = element_text(family = "Calibri"), text = element_text(family = "Calibri"))
# graphing_SS4_7<- ggplot(Sapiens_set4, aes(x=Gene, y=filtered_Average_7, color=Gene)) + scale_y_continuous(limits = c(0,6)) + geom_boxplot(alpha=1) + labs(title="Testing") + labs(x= "Gene", y="Mean Distance from Center") + theme(axis.line.x = element_line(linewidth = 0.5, colour = "black"), legend.position="bottom", legend.direction="horizontal", legend.title = element_blank(), plot.title = element_text(family = "Calibri"), text = element_text(family = "Calibri"))
# 
...
## For LUCA ##
# 
# LUCA_set2 <- LUCA_set %>% inner_join(filtered_Average_0, by = "Gene")
# LUCA_set2 <- LUCA_set2[, -c(10:19)]
# colnames(LUCA_set2)[colnames(LUCA_set2) == "filtered_Average"] <- "filtered_Average_0"
# 
# LUCA_set3 <- LUCA_set2 %>% inner_join(filtered_Average_1, by = "Gene")
# LUCA_set3 <- LUCA_set3[, -c(11:20)]
# colnames(LUCA_set3)[colnames(LUCA_set3) == "filtered_Average"] <- "filtered_Average_1"
# 
# LUCA_set4 <- LUCA_set3 %>% inner_join(filtered_Average_7, by = "Gene")
# LUCA_set4 <- LUCA_set4[, -c(12:21)]
# colnames(LUCA_set4)[colnames(LUCA_set4) == "filtered_Average"] <- "filtered_Average_7"
# 
# LUCA_set4 <- na.omit(LUCA_set4) #removes rows with NaNs

# 
# graphing_LS4_0<- ggplot(LUCA_set4, aes(x=Gene, y=filtered_Average_0, color=Gene)) + scale_y_continuous(limits = c(0,6)) + geom_boxplot(alpha=1) + labs(title="Testing") + labs(x= "Gene", y="Mean Distance from Center") + theme(axis.line.x = element_line(linewidth = 0.5, colour = "black"), legend.position="bottom", legend.direction="horizontal", legend.title = element_blank(), plot.title = element_text(family = "Calibri"), text = element_text(family = "Calibri"))
# graphing_LS4_1<- ggplot(LUCA_set4, aes(x=Gene, y=filtered_Average_1, color=Gene)) + scale_y_continuous(limits = c(0,6)) + geom_boxplot(alpha=1) + labs(title="Testing") + labs(x= "Gene", y="Mean Distance from Center") + theme(axis.line.x = element_line(linewidth = 0.5, colour = "black"), legend.position="bottom", legend.direction="horizontal", legend.title = element_blank(), plot.title = element_text(family = "Calibri"), text = element_text(family = "Calibri"))
# graphing_LS4_7<- ggplot(LUCA_set4, aes(x=Gene, y=filtered_Average_7, color=Gene)) + scale_y_continuous(limits = c(0,6)) + geom_boxplot(alpha=1) + labs(title="Testing") + labs(x= "Gene", y="Mean Distance from Center") + theme(axis.line.x = element_line(linewidth = 0.5, colour = "black"), legend.position="bottom", legend.direction="horizontal", legend.title = element_blank(), plot.title = element_text(family = "Calibri"), text = element_text(family = "Calibri"))
# 
...
## For Mammalia ##
# 
# Mammalia_set2 <- Mammalia_set %>% inner_join(filtered_Average_0, by = "Gene")
# Mammalia_set2 <- Mammalia_set2[, -c(10:19)]
# colnames(Mammalia_set2)[colnames(Mammalia_set2) == "filtered_Average"] <- "filtered_Average_0"
# 
# Mammalia_set3 <- Mammalia_set2 %>% inner_join(filtered_Average_1, by = "Gene")
# Mammalia_set3 <- Mammalia_set3[, -c(11:20)]
# colnames(Mammalia_set3)[colnames(Mammalia_set3) == "filtered_Average"] <- "filtered_Average_1"
# 
# Mammalia_set4 <- Mammalia_set3 %>% inner_join(filtered_Average_7, by = "Gene")
# Mammalia_set4 <- Mammalia_set4[, -c(12:21)]
# colnames(Mammalia_set4)[colnames(Mammalia_set4) == "filtered_Average"] <- "filtered_Average_7"
# 
...
## Functioning & Sub-setting with filtered_filtered_Average

filtered_subsetting <- function (x){
        x.1 <- x %>% inner_join(filtered_filtered_Average_0, by = "Gene")
        x.1 <- x.1[, -c(10:19)]
        colnames(x.1)[colnames(x.1) == "filtered_Average"] <- "filtered_Average_0"
        x.2 <- x.1 %>% inner_join(filtered_filtered_Average_1, by = "Gene")
        x.2 <- x.2[, -c(11:20)]
        colnames(x.2)[colnames(x.2) == "filtered_Average"] <- "filtered_Average_1"
        x.3 <- x.2 %>% inner_join(filtered_filtered_Average_7, by = "Gene")
        x.3 <- x.3[, -c(12:21)]
        colnames(x.3)[colnames(x.3) == "filtered_Average"] <- "filtered_Average_7"
        x.4 <- x.3 %>% mutate(Total_filtered_Average=rowMeans(x.3[, c('filtered_Average_0', 'filtered_Average_1', 'filtered_Average_7' )]))
        x.5 <- na.omit(x.4)
        return(x.5)
}
...
LUCA_graph_0 <-ggplot(subset(LUCA, !is.na(chr.x)), aes(x = chr.x, y = filtered_Average_0)) + 
        scale_x_discrete() +
        ...
        geom_segment(data = LUCA_sum,
                     aes(x = as.numeric(chr.x) - 0.4, 
                         ...
                         y = Total_filtered_Average, yend = Total_filtered_Average), 
                     inherit.aes = TRUE, colour = 'orange', size = 1)

LUCA_graph_1 <-ggplot(subset(LUCA, !is.na(chr.x)), aes(x = chr.x, y = filtered_Average_1))  + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
LUCA_graph_7 <-ggplot(subset(LUCA, !is.na(chr.x)), aes(x = chr.x, y = filtered_Average_7)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
Sapiens_graph_0 <-ggplot(Sapiens, aes(x = chr.x, y = filtered_Average_0)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
Sapiens_graph_1 <-ggplot(Sapiens, aes(x = chr.x, y = filtered_Average_1)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
Sapiens_graph_7 <-ggplot(Sapiens, aes(x = chr.x, y = filtered_Average_7)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
Mammalia_graph_0 <-ggplot(Mammalia, aes(x = chr.x, y = filtered_Average_0)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
Mammalia_graph_1 <-ggplot(Mammalia, aes(x = chr.x, y = filtered_Average_1)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
        geom_boxplot(alpha=1) +
        labs(title="1 dpi") + 
...
Mammalia_graph_7 <-ggplot(Mammalia, aes(x = chr.x, y = filtered_Average_7)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
        geom_boxplot(alpha=1) +
        labs(title="7 dpi") + 
...
Eutheria_graph_0 <-ggplot(Eutheria, aes(x = chr.x, y = filtered_Average_0)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
        geom_boxplot(alpha=1) +
        labs(title="0 dpi") + 
...
Eutheria_graph_1 <-ggplot(Eutheria, aes(x = chr.x, y = filtered_Average_1)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
        geom_boxplot(alpha=1) +
        labs(title="1 dpi") + 
...
Eutheria_graph_7 <-ggplot(Eutheria, aes(x = chr.x, y = filtered_Average_7)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
        geom_boxplot(alpha=1) +
        labs(title="7 dpi") + 
...
Eukaryota_graph_0 <-ggplot(Eukaryota, aes(x = chr.x, y = filtered_Average_0)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
Eukaryota_graph_1 <-ggplot(Eukaryota, aes(x = chr.x, y = filtered_Average_1)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
Eukaryota_graph_7 <-ggplot(Eukaryota, aes(x = chr.x, y = filtered_Average_7)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
Metazoa_graph_0 <-ggplot(Metazoa, aes(x = chr.x, y = filtered_Average_0)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
Metazoa_graph_1 <-ggplot(Metazoa, aes(x = chr.x, y = filtered_Average_1)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
Metazoa_graph_7 <-ggplot(Metazoa, aes(x = chr.x, y = filtered_Average_7)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
Euteleostomi_graph_0 <-ggplot(Euteleostomi, aes(x = chr.x, y = filtered_Average_0)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
Euteleostomi_graph_1 <-ggplot(Euteleostomi, aes(x = chr.x, y = filtered_Average_1)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
Euteleostomi_graph_7 <-ggplot(Euteleostomi, aes(x = chr.x, y = filtered_Average_7)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
Theria_graph_0 <-ggplot(Theria, aes(x = chr.x, y = filtered_Average_0)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
Theria_graph_1 <-ggplot(Theria, aes(x = chr.x, y = filtered_Average_1)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
Theria_graph_7 <-ggplot(Theria, aes(x = chr.x, y = filtered_Average_7)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
Eumetazoa_graph_0 <-ggplot(Eumetazoa, aes(x = chr.x, y = filtered_Average_0)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
Eumetazoa_graph_1 <-ggplot(Eumetazoa, aes(x = chr.x, y = filtered_Average_1)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
Eumetazoa_graph_7 <-ggplot(Eumetazoa, aes(x = chr.x, y = filtered_Average_7)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
Homininae_graph_0 <-ggplot(Homininae, aes(x = chr.x, y = filtered_Average_0)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
Homininae_graph_1 <-ggplot(Homininae, aes(x = chr.x, y = filtered_Average_1)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
Homininae_graph_7 <-ggplot(Homininae, aes(x = chr.x, y = filtered_Average_7)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
Amniota_graph_0 <-ggplot(Amniota, aes(x = chr.x, y = filtered_Average_0)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
Amniota_graph_1 <-ggplot(Amniota, aes(x = chr.x, y = filtered_Average_1)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
Amniota_graph_7 <-ggplot(Amniota, aes(x = chr.x, y = filtered_Average_7)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
Chordata_graph_0 <-ggplot(Chordata, aes(x = chr.x, y = filtered_Average_0)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
Chordata_graph_1 <-ggplot(Chordata, aes(x = chr.x, y = filtered_Average_1)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
Chordata_graph_7 <-ggplot(Chordata, aes(x = chr.x, y = filtered_Average_7)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
Bilateria_graph_0 <-ggplot(Bilateria, aes(x = chr.x, y = filtered_Average_0)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
Bilateria_graph_1 <-ggplot(Bilateria, aes(x = chr.x, y = filtered_Average_1)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
Bilateria_graph_7 <-ggplot(Bilateria, aes(x = chr.x, y = filtered_Average_7)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
Euarchontoglires_graph_0 <-ggplot(Euarchontoglires, aes(x = chr.x, y = filtered_Average_0)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
Euarchontoglires_graph_1 <-ggplot(Euarchontoglires, aes(x = chr.x, y = filtered_Average_1)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
Euarchontoglires_graph_7 <-ggplot(Euarchontoglires, aes(x = chr.x, y = filtered_Average_7)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
Opisthokonta_graph_0 <-ggplot(Opisthokonta, aes(x = chr.x, y = filtered_Average_0)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
Opisthokonta_graph_1 <-ggplot(Opisthokonta, aes(x = chr.x, y = filtered_Average_1)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
Opisthokonta_graph_7 <-ggplot(Opisthokonta, aes(x = chr.x, y = filtered_Average_7)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
Catarrhini_graph_0 <-ggplot(Catarrhini, aes(x = chr.x, y = filtered_Average_0)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
Catarrhini_graph_1 <-ggplot(Catarrhini, aes(x = chr.x, y = filtered_Average_1)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
Catarrhini_graph_7 <-ggplot(Catarrhini, aes(x = chr.x, y = filtered_Average_7)) + 
        scale_x_discrete() +
        scale_y_continuous(limits = c(0,6)) + 
...
tiff(filename = "D:/Dropbox/DUTh/Thesis/SF/hgh_res/high_res_final_plot_filtered_pheatmap_0.tiff",
...
pheatmap(as.matrix(Phylo_sum_0),
         ...
         cutree_rows=2,
         fontsize_row = 5, fontsize = 10, fontsize_col = 10, angle_col= NULL,
         main= "Phylogenetic Heatmap (0 dpi)",
...
tiff(filename = "D:/Dropbox/DUTh/Thesis/SF/hgh_res/high_res_final_plot_filtered_pheatmap_1.tiff",
     width = 20, height = 15, units = "in", res = 600,
     family = "serif", compression = "lzw", bg = "white")
...
pheatmap(as.matrix(Phylo_sum_1),
         ...
         cutree_rows=2,
         fontsize_row = 5, fontsize = 10, fontsize_col = 10, angle_col= NULL,
         main= "Phylogenetic Heatmap (1 dpi)",
         annotation_names_col = FALSE,
         display_numbers = FALSE, number_format = "%.2f",
         fontsize_number = 5, number_color = 'black',
         cellheight = 25, cellwidth = 50)
...
tiff(filename = "D:/Dropbox/DUTh/Thesis/SF/hgh_res/high_res_final_plot_filtered_pheatmap_7.tiff",
     width = 20, height = 15, units = "in", res = 600,
     family = "serif", compression = "lzw", bg = "white")
...
pheatmap(as.matrix(Phylo_sum_7),
         ...
         cutree_rows=2,
         fontsize_row = 5, fontsize = 10, fontsize_col = 10, angle_col= NULL,
         main= "Phylogenetic Heatmap (7 dpi)",
         annotation_names_col = FALSE,
         display_numbers = FALSE, number_format = "%.2f",
         fontsize_number = 5, number_color = 'black',
         cellheight = 25, cellwidth = 50)
